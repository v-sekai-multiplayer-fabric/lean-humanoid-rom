...
Humanoid range-of-motion / IK constraints (core); B3D/AddBiomechanics parsers + Kusudama GPU shader + python tools (adapters).
...
```sh
lake build           # production gate: `lake build HumanoidRom`
